...
class sampleseries ():
    ...
    def load(self):
        self.samples=[3.3, 3.4, 3.5, 3.6, 3.5, 3.6, 3.5, 3.6, 3.5, 3.4, 3.3, 3.4, 3.5, 3.6, 3.7, 3.8, 3.9, 4.0, 3.9, 4.0]
        print self.samples
        print ("len of samples=" + str(self.samples.__len__()))

        self.times=[time.strptime("16 Feb 07 00:56", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 01:00", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 01:08", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 01:14", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 01:22", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 01:32", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 01:53", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 01:59", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 02:09", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 02:12", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 02:18", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 02:19", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 02:26", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 02:36", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 02:53", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 03:34", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 03:44", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 04:01", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 04:04", "%y %b %d %H:%M"),
                    time.strptime("16 Feb 07 04:08", "%y %b %d %H:%M")]
