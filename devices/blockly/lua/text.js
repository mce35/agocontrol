...
Blockly.Lua['text_format'] = function(block) {
  var code = 'string.format(' + Blockly.Lua.valueToCode(block, 'FORMAT', Blockly.Lua.ORDER_ATOMIC) + ',' + Blockly.Lua.valueToCode(block, 'ITEM', Blockly.Lua.ORDER_ATOMIC) + ')';
  return [code, Blockly.Lua.ORDER_ATOMIC];
};
