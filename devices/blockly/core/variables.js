...
Blockly.Variables.flyoutCategory = function(blocks, gaps, margin, workspace) {
  ...
  //tang: append is_defined block
  var isDefinedBlock = Blockly.Blocks['variables_is_defined'] ?
      Blockly.Block.obtain(workspace, 'variables_is_defined') : null;
  isDefinedBlock && isDefinedBlock.initSvg();
  isDefinedBlock && blocks.push(isDefinedBlock);
};
